        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="card">
            <div className="bg-yellow-50 border border-yellow-200 text-yellow-700 px-4 py-3 rounded-lg">
              ...
              <p>Please add REACT_APP_GOOGLE_MAPS_API_KEY to your frontend/.env file and restart the development server.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="card mb-6">
          ...
          {isLoaded ? (
            ...
            <div className="mb-6 bg-yellow-50 border border-yellow-200 text-yellow-700 px-4 py-3 rounded-lg">
              {!apiKey ? (
                <p>⚠️ Google Maps API key is not configured. Please add REACT_APP_GOOGLE_MAPS_API_KEY to your .env file.</p>
              ) : (
                <p>Loading map...</p>
              )}
            </div>
